...
// Purpose: Script used for animating background #2 and defining scroll speed variables
//------------------------------------------------------------------------------------------------
using UnityEngine;
using System.Collections;

public class AnimatedBackground2 : MonoBehaviour {
    ...
    void Start () 
    {
        GetComponent<Renderer>().material.SetColor("color", Color.clear);
    }
